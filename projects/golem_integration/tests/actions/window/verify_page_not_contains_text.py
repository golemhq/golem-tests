...
def test(data):
    ...
    golem_steps.assert_last_step_message("Verify 'THIS TEXT IS NOT PRESENT' is not present in page")
    actions.verify_page_not_contains_text('Special Elements')
    golem_steps.assert_last_error("text 'Special Elements' was found in page")
