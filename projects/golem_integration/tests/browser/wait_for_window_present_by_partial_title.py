...
def test(data):
    ...
    actions.get_browser().wait_for_window_present_by_partial_title('MY TI', timeout=4)
    ...
    with expected_exception(Exception, msg):
        actions.get_browser().wait_for_window_present_by_partial_title('TITLE NOT PRESENT', timeout=2)
